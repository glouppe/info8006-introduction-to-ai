...
class CheekyGhost1(GhostAgent):
    ...
    # PathSearching in tree with depth
    def _pathsearch(self, state, fscore_in, gscore_in, goal):
        ...
        while not fringe.isEmpty():
            ...
            # Making copies of it
            curNode, actions, closed, t_depth = node
...
#---------------------------
class CheekyGhost10(GhostAgent):
