...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \danger The execution the \texttt{move(grid)} method is subject to a time limit.
    \end{itemize}
    \item Deliverable 2: A report of 3 pages (max.) which describes your work. Appendices with some statistics accepted.
    \item Upload your deliverables (\texttt{agent.py} and \texttt{report.pdf}) on the \href{http://submit.montefiore.ulg.ac.be/student/viewprojects/INFO8006}{Montefiore submission platform}.
