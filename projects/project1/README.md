...
You can download the **[archive](https://github.com/glouppe/info8006-introduction-to-ai/blob/master/projects/project1.tar.gz)** of the project into a directory of your choice. In this first part of the project, only food dots and Pacman are in the maze.
