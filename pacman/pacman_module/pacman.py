...
def runGame( layout_name, pacman, ghosts, displayGraphics, timeout=30, ris=False ):
    display = graphicsDisplay.PacmanGraphics(1.0,frameTime=0.1) if displayGraphics else textDisplay.NullGraphics()
    import __main__
    __main__.__dict__['_display'] = display
