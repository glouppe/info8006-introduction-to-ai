...
class PMAgent(Agent):
    ...
    def __init__(self, args):
        ...
        lis = keyboard.Listener(on_press=self._on_press,on_release=self._on_release)
        lis.start()
        pass
    ...
    def _getMove(self, legal):
        ...
        if   self.pressedKey == self.WEST_KEY and Directions.WEST in legal:  move = Directions.WEST
        elif   self.pressedKey == self.EAST_KEY and Directions.EAST in legal: move = Directions.EAST
        elif   self.pressedKey == self.NORTH_KEY and Directions.NORTH in legal:   move = Directions.NORTH
        elif   self.pressedKey == self.SOUTH_KEY and Directions.SOUTH in legal: move = Directions.SOUTH
        elif self.pressedKey == self.lastMove and self.lastMove in legal : move = self.lastMove
        self.lastMove = move
        return move
