...
\title{Assignment 1}
\subtitle{\textsc{\texttt{When AI meets problem statement and data structure}}\\\horrule{2pt}\\[0.5cm]}
...
\begin{tikzpicture}[inner sep=0pt,scale=0.33]
...
\end{tikzpicture}
\begin{tikzpicture}[inner sep=0pt, scale=0.33]
\node (n0) [minimum height=15.0pt, minimum width=15.0pt,at={(514pt,-187pt)}, fill=green, draw, line width=1.0pt,align=center,text width=11.634765625,font=\fontfamily{phv}\fontsize{12}{13}\selectfont, shape=circle] {1};
...
\node (n7) [minimum height=15.0pt, minimum width=15.0pt,at={(1073pt,-296pt)}, fill=yellow, draw, line width=1.0pt,align=center,text width=11.634765625,font=\fontfamily{phv}\fontsize{12}{13}\selectfont, shape=circle] {8};
\path [->,line width=1.0pt,draw,](n1)--(n0);
\path [->,line width=1.0pt,draw,](n0)--(n2);
\path [->,line width=1.0pt,draw,](n0)--(n4);
