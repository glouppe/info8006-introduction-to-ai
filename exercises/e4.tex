...
\titledquestion{Nuclear power plant \aima{13}}
...
\titledquestion{Car diagnosis \aima{13}}
...
Considering the Bayesian network below, which of the following statements are enforced by the network structure?
