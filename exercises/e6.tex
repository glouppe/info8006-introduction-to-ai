    ...
    \begin{solution}
        ...
        \begin{center}
            \begin{tikzpicture}[node distance = 2cm]
                \node[state, align=center] (H) {$H_t$};
                \node[state, align=center] (R) [below right of=H] {$R_t$};
                \node[state, align=center] (F) [below right of=R] {$F_t$};
                \node[state, align=center] (C) [below left of=R] {$C_t$};
                \node[state, align=center] (H1) [above right of=R] {$H_{t+1}$};
                
                \path[-{>[scale=1.5]}] (H) edge (C);
                \path[-{>[scale=1.5]}] (H) edge (R);
                \path[-{>[scale=1.5]}] (F) edge (R);
                \path[-{>[scale=1.5]}] (H) edge (H1);
                \path[-{>[scale=1.5]}] (F) edge (H1);
            \end{tikzpicture}
        \end{center}
